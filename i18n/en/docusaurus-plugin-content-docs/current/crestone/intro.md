...
## Documentation and Commercial Material

<div class="padding-vert--sd">

<BoxDoc
  title="Agnostic brochure (Horizontal)"
  language="Español"
  format="PDF"
  brand="Crestone"
...
>
  Commercial material in landscape format, designed to communicate Crestone's capabilities without mentioning specific brands. Ideal for general presentations and neutral use cases.
</BoxDoc>

<BoxDoc
  title="Agnostic brochure (vertical)"
  language="Español"
  format="PDF"
  brand="Crestone"
  titleimg="Brochure comercial"
...
>
  Vertical format version of the commercial brochure, with the same agnostic approach: highlighting Crestone's features without references to cloud providers or databases.
</BoxDoc>
...
>
  Complete sales document that includes an updated list of all brands and platforms supported by Crestone, highlighting their scope and compatibility.
</BoxDoc>
...
>
  Corporate presentation ready to be shown, with all the key information about Crestone: features, benefits, use cases, and integration ecosystem.
</BoxDoc>
